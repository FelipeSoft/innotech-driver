...
const variants = {
    executing: "text-emerald-700 bg-emerald-700 bg-emerald-700/30 dark:bg-emerald-700/70",
    stopped: "text-yellow-600 bg-yellow-600 bg-yellow-600/30 dark:bg-yellow-600/70",
    finished: "text-blue-600 bg-blue-600 bg-blue-600/30 dark:bg-blue-600/70",
    canceled: "text-red-600 bg-red-600 bg-red-600/30 dark:bg-red-600/70"
}
